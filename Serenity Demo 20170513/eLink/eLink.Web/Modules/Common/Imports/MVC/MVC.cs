...
namespace MVC
{
    public static class Views
    {
        ...
        public static class BookingVcmReport
        {
            public static class CssVcmBaoCaoDanhSachPOSapNhan
            {
                public const string CssVcmBaoCaoDanhSachPOSapNhanIndex = "~/Modules/BookingVcmReport/CssVcmBaoCaoDanhSachPOSapNhan/CssVcmBaoCaoDanhSachPOSapNhanIndex.cshtml";
            }

            public static class CssVcmBaoCaoDatHangKheThoiGian
            {
                public const string CssVcmBaoCaoDatHangKheThoiGianIndex = "~/Modules/BookingVcmReport/CssVcmBaoCaoDatHangKheThoiGian/CssVcmBaoCaoDatHangKheThoiGianIndex.cshtml";
            }

            public static class CssVcmBaoCaoDatHangThang
            {
                public const string CssVcmBaoCaoDatHangThangIndex = "~/Modules/BookingVcmReport/CssVcmBaoCaoDatHangThang/CssVcmBaoCaoDatHangThangIndex.cshtml";
            }

            public static class CssVcmBaoCaoNCC
            {
                public const string CssVcmBaoCaoNCCIndex = "~/Modules/BookingVcmReport/CssVcmBaoCaoNCC/CssVcmBaoCaoNCCIndex.cshtml";
            }

            public static class CssVcmDanhSachPo
            {
                public static class Indext
                {
                    public const string CssVcmDanhSachPo_KhoXacNhanLichGiaoIndex = "~/Modules/BookingVcmReport/CssVcmDanhSachPo/Indext/CssVcmDanhSachPo_KhoXacNhanLichGiaoIndex.cshtml";
                    public const string CssVcmDanhSachPo_NhaCungCapHenGiaoIndex = "~/Modules/BookingVcmReport/CssVcmDanhSachPo/Indext/CssVcmDanhSachPo_NhaCungCapHenGiaoIndex.cshtml";
                    public const string CssVcmDanhSachPo_ThongTinKhoDaXacNhanIndex = "~/Modules/BookingVcmReport/CssVcmDanhSachPo/Indext/CssVcmDanhSachPo_ThongTinKhoDaXacNhanIndex.cshtml";
                    public const string CssVcmDanhSachPoIndex = "~/Modules/BookingVcmReport/CssVcmDanhSachPo/Indext/CssVcmDanhSachPoIndex.cshtml";
                }
            }

            public static class CssVcmDanhSachPoChart
            {
                public const string Index = "~/Modules/BookingVcmReport/CssVcmDanhSachPoChart/Index.cshtml";
            }

            public static class CssVcmDanhSachPoDet
            {
                public const string CssVcmDanhSachPoDetIndex = "~/Modules/BookingVcmReport/CssVcmDanhSachPoDet/CssVcmDanhSachPoDetIndex.cshtml";
            }
        ...
        public static class QuanLyHocSinh
        {
            public static class QuanLyHocSinh_
            {
                public const string QuanLyHocSinhIndex = "~/Modules/QuanLyHocSinh/QuanLyHocSinh/QuanLyHocSinhIndex.cshtml";
            }
        }
