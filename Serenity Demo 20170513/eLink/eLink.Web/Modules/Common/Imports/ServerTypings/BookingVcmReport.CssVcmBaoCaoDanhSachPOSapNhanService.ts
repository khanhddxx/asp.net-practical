namespace eLink.BookingVcmReport {
    export namespace CssVcmBaoCaoDanhSachPOSapNhanService {
        export const baseUrl = 'BookingVcmReport/CssVcmBaoCaoDanhSachPOSapNhan';
        ...
        ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(x => {
            (<any>CssVcmBaoCaoDanhSachPOSapNhanService)[x] = function (r, s, o) { return Q.serviceRequest(baseUrl + '/' + x, r, s, o); };
