...
(function (eLink) {
    ...
    })(Administration = eLink.Administration || (eLink.Administration = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Administration;
...
(function (eLink) {
    ...
    })(Authorization = eLink.Authorization || (eLink.Authorization = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Administration;
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        var ChartInDialog_1;
    })(BasicSamples = eLink.BasicSamples || (eLink.BasicSamples = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Northwind;
    (function (Northwind) {
        var ProductDialog = (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () {
                return eLink.LanguageList.getValue();
            };
    ...
    })(Northwind = eLink.Northwind || (eLink.Northwind = {}));
})(eLink || (eLink = {}));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: eLink.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: eLink.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new eLink.Northwind.OrderDialog();
                        ...
                        var chai = eLink.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = eLink.Northwind.EmployeeRow.getLookup().items
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    eLink.Northwind.CategoryService.Retrieve({
        ...
        }(eLink.Northwind.CategoryDialog));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(eLink.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(eLink.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new eLink.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                eLink.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(eLink.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    eLink.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(eLink.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(eLink.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    eLink.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return eLink.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return eLink.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return eLink.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return eLink.Northwind.OrderService.baseUrl; };
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        }(eLink.Northwind.SupplierDialog));
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return eLink.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return eLink.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return eLink.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return eLink.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return eLink.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                eLink.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    eLink.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(eLink.Northwind.CustomerDialog));
...
(function (eLink) {
    ...
    })(Common = eLink.Common || (eLink.Common = {}));
})(eLink || (eLink = {}));
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = eLink.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return eLink.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return eLink.Northwind.ProductRow.lookupKey;
            };
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        }(eLink.Northwind.OrderDetailsEditor));
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return eLink.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return eLink.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return eLink.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return eLink.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new eLink.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = eLink.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(eLink.Northwind.OrderDetailDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return eLink.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (eLink) {
    ...
    eLink.StaticTextBlock = StaticTextBlock;
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BasicSamples;
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return eLink.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return eLink.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return eLink.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return eLink.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = eLink.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = eLink.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(eLink.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new eLink.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new eLink.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new eLink.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, eLink.Northwind.OrderRow.Fields.ShipCountry);
...
(function (eLink) {
    ...
    eLink.SelectableEntityGrid = SelectableEntityGrid;
})(eLink || (eLink = {}));
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return eLink.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return eLink.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return eLink.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return eLink.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(eLink.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = eLink.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            eLink.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return eLink.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return eLink.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return eLink.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return eLink.Northwind.ProductService.baseUrl; };
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return eLink.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return eLink.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return eLink.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return eLink.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: eLink.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return eLink.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return eLink.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return eLink.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDanhSachPOSapNhanGrid = (function (_super) {
            __extends(CssVcmBaoCaoDanhSachPOSapNhanGrid, _super);
            function CssVcmBaoCaoDanhSachPOSapNhanGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmBaoCaoDanhSachPOSapNhan'; };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.getDialogType = function () { return BookingVcmReport.CssVcmDanhSachPoDialog; };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoRow.idProperty; };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoRow.localTextPrefix; };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.getService = function () { return 'BookingVcmReport/CssVcmBaoCaoDanhSachPOSapNhan'; };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                //this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.getButtons = function () {
                var buttons = [];
                return buttons;
            };
            CssVcmBaoCaoDanhSachPOSapNhanGrid.prototype.createQuickSearchInput = function () { return null; };
            return CssVcmBaoCaoDanhSachPOSapNhanGrid;
        }(Serenity.EntityGrid));
        CssVcmBaoCaoDanhSachPOSapNhanGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmBaoCaoDanhSachPOSapNhanGrid);
        BookingVcmReport.CssVcmBaoCaoDanhSachPOSapNhanGrid = CssVcmBaoCaoDanhSachPOSapNhanGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangKheThoiGianGrid = (function (_super) {
            __extends(CssVcmBaoCaoDatHangKheThoiGianGrid, _super);
            function CssVcmBaoCaoDatHangKheThoiGianGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGian'; };
            //protected getDialogType() { return CssVcmBaoCaoDatHangKheThoiGianDialog; }
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianRow.idProperty; };
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianRow.localTextPrefix; };
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getService = function () { return BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianService.baseUrl; };
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push(eLink.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                ...
                buttons.push({
                    ...
                    cssClass: 'expand-all-button',
                    onClick: function () { return _this.view.setGrouping([{
                            formatter: function (x) { return String(x.value); },
                            getter: 'NgayGiao'
                        }]); }
                });
                buttons.push({
            ...
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.createSlickGrid = function () {
                var grid = _super.prototype.createSlickGrid.call(this);
                // need to register this plugin for grouping or you'll have errors
                grid.registerPlugin(new Slick.Data.GroupItemMetadataProvider());
                this.view.setSummaryOptions({
            ...
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getSlickOptions = function () {
                var opt = _super.prototype.getSlickOptions.call(this);
                opt.showFooterRow = true;
                return opt;
            };
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.createQuickSearchInput = function () { return null; };
            CssVcmBaoCaoDatHangKheThoiGianGrid.prototype.getQuickFilters = function () {
                var myDate = new Date();
                myDate.setDate(myDate.getDate() + 7);
                var filters = _super.prototype.getQuickFilters.call(this);
                var fld = BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianRow.Fields;
                Q.first(filters, function (x) { return x.field == fld.GioGiao; }).init = function (w) {
                    w.valueAsDate = new Date();
                    var endDate = w.element.nextAll(".s-DateEditor").getWidget(Serenity.DateEditor);
                    endDate.valueAsDate = myDate;
                };
                return filters;
            };
            return CssVcmBaoCaoDatHangKheThoiGianGrid;
        }(Serenity.EntityGrid));
        CssVcmBaoCaoDatHangKheThoiGianGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmBaoCaoDatHangKheThoiGianGrid);
        BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianGrid = CssVcmBaoCaoDatHangKheThoiGianGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangThangDialog = (function (_super) {
            __extends(CssVcmBaoCaoDatHangThangDialog, _super);
            function CssVcmBaoCaoDatHangThangDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new BookingVcmReport.CssVcmBaoCaoDatHangThangForm(_this.idPrefix);
                return _this;
            }
            CssVcmBaoCaoDatHangThangDialog.prototype.getFormKey = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangForm.formKey; };
            CssVcmBaoCaoDatHangThangDialog.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangRow.idProperty; };
            CssVcmBaoCaoDatHangThangDialog.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangRow.localTextPrefix; };
            CssVcmBaoCaoDatHangThangDialog.prototype.getNameProperty = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangRow.nameProperty; };
            CssVcmBaoCaoDatHangThangDialog.prototype.getService = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangService.baseUrl; };
            return CssVcmBaoCaoDatHangThangDialog;
        }(Serenity.EntityDialog));
        CssVcmBaoCaoDatHangThangDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CssVcmBaoCaoDatHangThangDialog);
        BookingVcmReport.CssVcmBaoCaoDatHangThangDialog = CssVcmBaoCaoDatHangThangDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangThangGrid = (function (_super) {
            __extends(CssVcmBaoCaoDatHangThangGrid, _super);
            function CssVcmBaoCaoDatHangThangGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmBaoCaoDatHangThangGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmBaoCaoDatHangThang'; };
            CssVcmBaoCaoDatHangThangGrid.prototype.getDialogType = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangDialog; };
            CssVcmBaoCaoDatHangThangGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangRow.idProperty; };
            CssVcmBaoCaoDatHangThangGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangRow.localTextPrefix; };
            CssVcmBaoCaoDatHangThangGrid.prototype.getService = function () { return BookingVcmReport.CssVcmBaoCaoDatHangThangService.baseUrl; };
            CssVcmBaoCaoDatHangThangGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push(eLink.Common.ExcelExportHelper.createToolButton({
                    grid: this,
            ...
            CssVcmBaoCaoDatHangThangGrid.prototype.createQuickSearchInput = function () { return null; };
            CssVcmBaoCaoDatHangThangGrid.prototype.getQuickFilters = function () {
                var myDate = new Date(), y = myDate.getFullYear(), m = myDate.getMonth();
                var firstDay = new Date(y, m, 1);
                var lastDay = new Date(y, m + 1, 0);
                var filters = _super.prototype.getQuickFilters.call(this);
                var fld = BookingVcmReport.CssVcmBaoCaoDatHangThangRow.Fields;
                Q.first(filters, function (x) { return x.field == fld.NgayDatHang; }).init = function (w) {
            ...
            return CssVcmBaoCaoDatHangThangGrid;
        }(Serenity.EntityGrid));
        CssVcmBaoCaoDatHangThangGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmBaoCaoDatHangThangGrid);
        BookingVcmReport.CssVcmBaoCaoDatHangThangGrid = CssVcmBaoCaoDatHangThangGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoNCCDialog = (function (_super) {
            __extends(CssVcmBaoCaoNCCDialog, _super);
            function CssVcmBaoCaoNCCDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new BookingVcmReport.CssVcmBaoCaoNCCForm(_this.idPrefix);
                return _this;
            }
            CssVcmBaoCaoNCCDialog.prototype.getFormKey = function () { return BookingVcmReport.CssVcmBaoCaoNCCForm.formKey; };
            CssVcmBaoCaoNCCDialog.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmBaoCaoNCCRow.idProperty; };
            CssVcmBaoCaoNCCDialog.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmBaoCaoNCCRow.localTextPrefix; };
            CssVcmBaoCaoNCCDialog.prototype.getNameProperty = function () { return BookingVcmReport.CssVcmBaoCaoNCCRow.nameProperty; };
            CssVcmBaoCaoNCCDialog.prototype.getService = function () { return BookingVcmReport.CssVcmBaoCaoNCCService.baseUrl; };
            return CssVcmBaoCaoNCCDialog;
        }(Serenity.EntityDialog));
        CssVcmBaoCaoNCCDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CssVcmBaoCaoNCCDialog);
        BookingVcmReport.CssVcmBaoCaoNCCDialog = CssVcmBaoCaoNCCDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoNCCGrid = (function (_super) {
            __extends(CssVcmBaoCaoNCCGrid, _super);
            function CssVcmBaoCaoNCCGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmBaoCaoNCCGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmBaoCaoNCC'; };
            CssVcmBaoCaoNCCGrid.prototype.getDialogType = function () { return BookingVcmReport.CssVcmBaoCaoNCCDialog; };
            CssVcmBaoCaoNCCGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmBaoCaoNCCRow.idProperty; };
            CssVcmBaoCaoNCCGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmBaoCaoNCCRow.localTextPrefix; };
            CssVcmBaoCaoNCCGrid.prototype.getService = function () { return BookingVcmReport.CssVcmBaoCaoNCCService.baseUrl; };
            CssVcmBaoCaoNCCGrid.prototype.getButtons = function () {
                var buttons = [];
                return buttons;
            };
            return CssVcmBaoCaoNCCGrid;
        }(Serenity.EntityGrid));
        CssVcmBaoCaoNCCGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmBaoCaoNCCGrid);
        BookingVcmReport.CssVcmBaoCaoNCCGrid = CssVcmBaoCaoNCCGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoCssVcmDanhSachPoDetDialog = (function (_super) {
            __extends(CssVcmDanhSachPoCssVcmDanhSachPoDetDialog, _super);
            function CssVcmDanhSachPoCssVcmDanhSachPoDetDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BookingVcmReport.CssVcmDanhSachPoDetForm(_this.idPrefix);
                return _this;
            }
            CssVcmDanhSachPoCssVcmDanhSachPoDetDialog.prototype.getFormKey = function () { return BookingVcmReport.CssVcmDanhSachPoDetForm.formKey; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetDialog.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.idProperty; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetDialog.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.localTextPrefix; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetDialog.prototype.getNameProperty = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.nameProperty; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetDialog.prototype.getService = function () { return BookingVcmReport.CssVcmDanhSachPoDetService.baseUrl; };
            return CssVcmDanhSachPoCssVcmDanhSachPoDetDialog;
        }(Serenity.EntityDialog));
        CssVcmDanhSachPoCssVcmDanhSachPoDetDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CssVcmDanhSachPoCssVcmDanhSachPoDetDialog);
        BookingVcmReport.CssVcmDanhSachPoCssVcmDanhSachPoDetDialog = CssVcmDanhSachPoCssVcmDanhSachPoDetDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoCssVcmDanhSachPoDetGrid = (function (_super) {
            __extends(CssVcmDanhSachPoCssVcmDanhSachPoDetGrid, _super);
            function CssVcmDanhSachPoCssVcmDanhSachPoDetGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmDanhSachPoDet'; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.idProperty; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.localTextPrefix; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype.getService = function () { return BookingVcmReport.CssVcmDanhSachPoDetService.baseUrl; };
            CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype.getButtons = function () {
                return null;
            };
            CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype.getGridCanLoad = function () {
                return this.maPo != null;
            };
            Object.defineProperty(CssVcmDanhSachPoCssVcmDanhSachPoDetGrid.prototype, "maPo", {
                get: function () {
                    return this._maPo;
                },
                set: function (value) {
                    if (this._maPo != value) {
                        this._maPo = value;
                        this.setEquality(BookingVcmReport.CssVcmDanhSachPoDetRow.Fields.MaPo, value);
                        this.refresh();
                    }
                },
                enumerable: true,
            ...
            return CssVcmDanhSachPoCssVcmDanhSachPoDetGrid;
        }(Serenity.EntityGrid));
        CssVcmDanhSachPoCssVcmDanhSachPoDetGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoCssVcmDanhSachPoDetGrid);
        BookingVcmReport.CssVcmDanhSachPoCssVcmDanhSachPoDetGrid = CssVcmDanhSachPoCssVcmDanhSachPoDetGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDialog = (function (_super) {
            __extends(CssVcmDanhSachPoDialog, _super);
            function CssVcmDanhSachPoDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BookingVcmReport.CssVcmDanhSachPoForm(_this.idPrefix);
                _this.CssVcmDanhSachPoDetGrid = new BookingVcmReport.CssVcmDanhSachPoCssVcmDanhSachPoDetGrid(_this.byId('CssVcmDanhSachPoCssVcmDanhSachPoDetGrid'));
                _this.tabs.bind('tabsactivate', function () { return _this.arrange(); });
                return _this;
            }
            CssVcmDanhSachPoDialog.prototype.getFormKey = function () { return BookingVcmReport.CssVcmDanhSachPoForm.formKey; };
            CssVcmDanhSachPoDialog.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoRow.idProperty; };
            CssVcmDanhSachPoDialog.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoRow.localTextPrefix; };
            CssVcmDanhSachPoDialog.prototype.getNameProperty = function () { return BookingVcmReport.CssVcmDanhSachPoRow.nameProperty; };
            CssVcmDanhSachPoDialog.prototype.getService = function () { return BookingVcmReport.CssVcmDanhSachPoService.baseUrl; };
            CssVcmDanhSachPoDialog.prototype.afterLoadEntity = function () {
                _super.prototype.afterLoadEntity.call(this);
                this.CssVcmDanhSachPoDetGrid.maPo = this.entityId;
            };
            CssVcmDanhSachPoDialog.prototype.getToolbarButtons = function () {
                var buttons = [];
                return buttons;
            };
            return CssVcmDanhSachPoDialog;
        }(Serenity.EntityDialog));
        CssVcmDanhSachPoDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CssVcmDanhSachPoDialog);
        BookingVcmReport.CssVcmDanhSachPoDialog = CssVcmDanhSachPoDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoEditor = (function (_super) {
            __extends(CssVcmDanhSachPoEditor, _super);
            function CssVcmDanhSachPoEditor(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoEditor.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmDanhSachPo'; };
            CssVcmDanhSachPoEditor.prototype.getDialogType = function () { return BookingVcmReport.CssVcmDanhSachPoDialog; };
            CssVcmDanhSachPoEditor.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoRow.localTextPrefix; };
            return CssVcmDanhSachPoEditor;
        }(eLink.Common.GridEditorBase));
        CssVcmDanhSachPoEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoEditor);
        BookingVcmReport.CssVcmDanhSachPoEditor = CssVcmDanhSachPoEditor;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoGrid = (function (_super) {
            __extends(CssVcmDanhSachPoGrid, _super);
            function CssVcmDanhSachPoGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmDanhSachPo'; };
            CssVcmDanhSachPoGrid.prototype.getDialogType = function () { return BookingVcmReport.CssVcmDanhSachPoDialog; };
            CssVcmDanhSachPoGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoRow.idProperty; };
            CssVcmDanhSachPoGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoRow.localTextPrefix; };
            CssVcmDanhSachPoGrid.prototype.getService = function () { return BookingVcmReport.CssVcmDanhSachPoService.baseUrl; };
            CssVcmDanhSachPoGrid.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            CssVcmDanhSachPoGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push({
                    title: "Nhập từ Excel",
                    cssClass: "export-xlsx-button",
                    onClick: function () {
                        var dialog = new BookingVcmReport.POExcelImportDialog();
                        dialog.element.on("dialogclose", function () {
                            _this.refresh();
                            dialog = null;
                        });
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        Q.confirm("Bạn có muốn hủy các đơn hàng này!", function () {
                            BookingVcmReport.CssVcmDanhSachPoService.DeletePO({
                                Keys: _this.rowSelection.getSelectedKeys()
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        Q.confirm("Bạn có muốn xác nhận các đơn hàng này!", function () {
                            BookingVcmReport.CssVcmDanhSachPoService.UpdateStatus({
                                Keys: _this.rowSelection.getSelectedKeys()
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        // open import dialog, let it handle rest
                        var dialog = new BookingVcmReport.POUpdateDeliveryDateDialog(_this.rowSelection.getSelectedKeys());
                        dialog.element.on("dialogclose", function () {
                            _this.refresh();
                            dialog = null;
                        });
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        Q.confirm("Bạn có muốn xác nhận giao các đơn hàng này!", function () {
                            BookingVcmReport.CssVcmDanhSachPoService.ConfirmWarehouseStatus({
                                Keys: _this.rowSelection.getSelectedKeys()
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
                                    Q.alert("Ph\u1EA3i x\u00E1c nh\u1EADn \u0111\u01A1n h\u00E0ng tr\u01B0\u1EDBc khi th\u1EF1c hi\u1EC7n\r\n" + response.ErrorList.join("\r\n"));
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        // open import dialog, let it handle rest
                        var dialog = new BookingVcmReport.PODenyWarehouseStatusDialog(_this.rowSelection.getSelectedKeys());
                        dialog.element.on("dialogclose", function () {
                            _this.refresh();
                            dialog = null;
                        });
            ...
            CssVcmDanhSachPoGrid.prototype.getColumns = function () {
                var _this = this;
                var columns = _super.prototype.getColumns.call(this);
                columns.splice(0, 0, Serenity.GridRowSelectionMixin.createSelectColumn(function () { return _this.rowSelection; }));
                return columns;
            };
            CssVcmDanhSachPoGrid.prototype.getViewOptions = function () {
                var opt = _super.prototype.getViewOptions.call(this);
                opt.rowsPerPage = 2500;
                return opt;
            };
            CssVcmDanhSachPoGrid.prototype.getQuickFilters = function () {
                var myDate = new Date();
                ...
                var filters = _super.prototype.getQuickFilters.call(this);
                var fld = BookingVcmReport.CssVcmDanhSachPoRow.Fields;
                Q.first(filters, function (x) { return x.field == fld.InsertDate; }).init = function (w) {
                    w.valueAsDate = firstDay;
                    var endDate = w.element.nextAll(".s-DateEditor").getWidget(Serenity.DateEditor);
                    endDate.valueAsDate = lastDay;
                };
            ...
            return CssVcmDanhSachPoGrid;
        }(Serenity.EntityGrid));
        CssVcmDanhSachPoGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoGrid);
        BookingVcmReport.CssVcmDanhSachPoGrid = CssVcmDanhSachPoGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoGrid_KhoUpDS = (function (_super) {
            __extends(CssVcmDanhSachPoGrid_KhoUpDS, _super);
            function CssVcmDanhSachPoGrid_KhoUpDS(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoGrid_KhoUpDS.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                //this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            CssVcmDanhSachPoGrid_KhoUpDS.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push(eLink.Common.ExcelExportHelper.createToolButton({
                    grid: this,
            ...
            return CssVcmDanhSachPoGrid_KhoUpDS;
        }(BookingVcmReport.CssVcmDanhSachPoGrid));
        CssVcmDanhSachPoGrid_KhoUpDS = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoGrid_KhoUpDS);
        BookingVcmReport.CssVcmDanhSachPoGrid_KhoUpDS = CssVcmDanhSachPoGrid_KhoUpDS;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoGrid_KhoXacNhanGiao = (function (_super) {
            __extends(CssVcmDanhSachPoGrid_KhoXacNhanGiao, _super);
            function CssVcmDanhSachPoGrid_KhoXacNhanGiao(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoGrid_KhoXacNhanGiao.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmDanhSachPoGrid_KhoXacNhanGiao'; };
            CssVcmDanhSachPoGrid_KhoXacNhanGiao.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                //this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            CssVcmDanhSachPoGrid_KhoXacNhanGiao.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        Q.confirm("Bạn có muốn xác nhận giao các đơn hàng này!", function () {
                            BookingVcmReport.CssVcmDanhSachPoService.ValidateXacNhanKhoXacNhanLichGiao({
                                Keys: _this.rowSelection.getSelectedKeys(),
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
                                    Q.confirm("\r\n" + response.ErrorList.join("\r\n") + "\r\nB\u1EA1n c\u00F3 mu\u1ED1n x\u00E1c nh\u1EADn kh\u00F4ng?", function () {
                                        BookingVcmReport.CssVcmDanhSachPoService.ConfirmWarehouseStatus({
                                            Keys: _this.rowSelection.getSelectedKeys(),
                                        }, function (response) {
                                            if (response.ErrorList != null && response.ErrorList.length > 0) {
            ...
            return CssVcmDanhSachPoGrid_KhoXacNhanGiao;
        }(BookingVcmReport.CssVcmDanhSachPoGrid));
        CssVcmDanhSachPoGrid_KhoXacNhanGiao = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoGrid_KhoXacNhanGiao);
        BookingVcmReport.CssVcmDanhSachPoGrid_KhoXacNhanGiao = CssVcmDanhSachPoGrid_KhoXacNhanGiao;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoGrid_NCCHenGiao = (function (_super) {
            __extends(CssVcmDanhSachPoGrid_NCCHenGiao, _super);
            function CssVcmDanhSachPoGrid_NCCHenGiao(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoGrid_NCCHenGiao.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                //this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            CssVcmDanhSachPoGrid_NCCHenGiao.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push({
                    title: "Cập nhật ngày giao",
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var request = Q.deepClone(_this.getView().params);
                        request.Keys = _this.rowSelection.getSelectedKeys();
                        request.IncludeColumns = [];
                        var columns = _this.getGrid().getColumns();
                ...
                buttons.push({
                    ...
                    cssClass: "export-xlsx-button",
                    onClick: function () {
                        var dialog = new BookingVcmReport.POExcelUpdateDialog();
                        dialog.element.on("dialogclose", function () {
                            _this.refresh();
                            dialog = null;
                        });
            ...
            return CssVcmDanhSachPoGrid_NCCHenGiao;
        }(BookingVcmReport.CssVcmDanhSachPoGrid));
        CssVcmDanhSachPoGrid_NCCHenGiao = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoGrid_NCCHenGiao);
        BookingVcmReport.CssVcmDanhSachPoGrid_NCCHenGiao = CssVcmDanhSachPoGrid_NCCHenGiao;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan = (function (_super) {
            __extends(CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan, _super);
            function CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                //this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push(eLink.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                ...
                buttons.push({
                    ...
                    cssClass: "export-xlsx-button",
                    onClick: function () {
                        var dialog = new BookingVcmReport.POExcelUpdateThongTinKhoXacNhanDialog();
                        dialog.element.on("dialogclose", function () {
                            _this.refresh();
                            dialog = null;
                        });
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dialog = new BookingVcmReport.KhoHuyLichDonHangDialog(_this.rowSelection.getSelectedKeys());
                        dialog.element.on("dialogclose", function () {
                            _this.rowSelection.clear();
                            _this.refresh();
                            dialog = null;
            ...
            return CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan;
        }(BookingVcmReport.CssVcmDanhSachPoGrid));
        CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan);
        BookingVcmReport.CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan = CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var KhoHuyLichDonHangDialog = (function (_super) {
            __extends(KhoHuyLichDonHangDialog, _super);
            function KhoHuyLichDonHangDialog(po) {
                var _this = _super.call(this) || this;
                _this.po = po;
                _this.form = new BookingVcmReport.KhoHuyLichDonHangForm(_this.idPrefix);
                return _this;
            }
            KhoHuyLichDonHangDialog.prototype.getDialogTitle = function () {
                return "Hủy lịch";
            };
            KhoHuyLichDonHangDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: 'Hủy lịch',
                        click: function () {
                            if (!_this.validateBeforeSave())
                                return;
                            BookingVcmReport.CssVcmDanhSachPoService.KhoHuyLichDonHang({
                                Keys: _this.po,
                                Note: _this.form.Note.value
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
                                    Q.alert("C\u00E1c \u0111\u01A1n h\u00E0ng sau c\u00F3 tr\u1EA1ng th\u00E1i \u0111\u00E3 nh\u1EADn h\u00E0ng! Kh\u00F4ng \u0111\u01B0\u1EE3c h\u1EE7y.\r\n" + response.ErrorList.join("\r\n"));
                                }
                                else {
                                    Q.notifyInfo("Đã hủy lịch thành công cho " + (response.Updated || 0) + " PO");
                                }
                                _this.dialogClose();
                            });
                        }
            ...
            return KhoHuyLichDonHangDialog;
        }(Serenity.PropertyDialog));
        KhoHuyLichDonHangDialog = __decorate([
            Serenity.Decorators.registerClass()
        ], KhoHuyLichDonHangDialog);
        BookingVcmReport.KhoHuyLichDonHangDialog = KhoHuyLichDonHangDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var PODenyWarehouseStatusDialog = (function (_super) {
            __extends(PODenyWarehouseStatusDialog, _super);
            function PODenyWarehouseStatusDialog(po) {
                var _this = _super.call(this) || this;
                _this.po = po;
                _this.form = new BookingVcmReport.PODenyWarehouseStatusForm(_this.idPrefix);
                return _this;
            }
            PODenyWarehouseStatusDialog.prototype.getDialogTitle = function () {
                return "Kho từ chối giao hàng";
            };
            PODenyWarehouseStatusDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: "Cập nhật",
                        click: function () {
                            if (!_this.validateBeforeSave())
                                return;
                            BookingVcmReport.CssVcmDanhSachPoService.DenyWarehouseStatus({
                                Keys: _this.po,
                                Note: _this.form.Note.value
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
            ...
            return PODenyWarehouseStatusDialog;
        }(Serenity.PropertyDialog));
        PODenyWarehouseStatusDialog = __decorate([
            Serenity.Decorators.registerClass()
        ], PODenyWarehouseStatusDialog);
        BookingVcmReport.PODenyWarehouseStatusDialog = PODenyWarehouseStatusDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POExcelImportDialog = (function (_super) {
            __extends(POExcelImportDialog, _super);
            function POExcelImportDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BookingVcmReport.POExcelImportForm(_this.idPrefix);
                return _this;
            }
            POExcelImportDialog.prototype.getDialogTitle = function () {
                return "Nhập liệu Excel";
            };
            POExcelImportDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: "Nhập",
                        click: function () {
                            ...
                            BookingVcmReport.CssVcmDanhSachPoService.ExcelImport({
                                FileName: _this.form.FileName.value.Filename
                            }, function (response) {
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
                                    ...
                                    Q.notifyInfo("Upload th\u00E0nh c\u00F4ng " + (response.Inserted || 0) + " PO");
                                }
                                _this.dialogClose();
                            });
                        }
            ...
            return POExcelImportDialog;
        }(Serenity.PropertyDialog));
        POExcelImportDialog = __decorate([
            Serenity.Decorators.registerClass()
        ], POExcelImportDialog);
        BookingVcmReport.POExcelImportDialog = POExcelImportDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POExcelUpdateDialog = (function (_super) {
            __extends(POExcelUpdateDialog, _super);
            function POExcelUpdateDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BookingVcmReport.POExcelUpdateForm(_this.idPrefix);
                return _this;
            }
            POExcelUpdateDialog.prototype.getDialogTitle = function () {
                return "Cập nhật từ Excel";
            };
            POExcelUpdateDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: "Nhập",
                        click: function () {
                            ...
                            BookingVcmReport.CssVcmDanhSachPoService.ExcelUpdate({
                                FileName: _this.form.FileName.value.Filename
                            }, function (response) {
                                Q.notifyInfo("Inserted: " + (response.Inserted || 0));
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
            ...
            return POExcelUpdateDialog;
        }(Serenity.PropertyDialog));
        POExcelUpdateDialog = __decorate([
            Serenity.Decorators.registerClass()
        ], POExcelUpdateDialog);
        BookingVcmReport.POExcelUpdateDialog = POExcelUpdateDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POExcelUpdateThongTinKhoXacNhanDialog = (function (_super) {
            __extends(POExcelUpdateThongTinKhoXacNhanDialog, _super);
            function POExcelUpdateThongTinKhoXacNhanDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BookingVcmReport.POExcelUpdateThongTinKhoXacNhanForm(_this.idPrefix);
                return _this;
            }
            POExcelUpdateThongTinKhoXacNhanDialog.prototype.getDialogTitle = function () {
                return "Upload dữ liệu nhận thực tế";
            };
            POExcelUpdateThongTinKhoXacNhanDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: "Nhập",
                        click: function () {
                            ...
                            BookingVcmReport.CssVcmDanhSachPoService.ExcelUpdateThongTinKhoXacNhan({
                                FileName: _this.form.FileName.value.Filename
                            }, function (response) {
                                Q.notifyInfo("Inserted: " + (response.Inserted || 0));
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
            ...
            return POExcelUpdateThongTinKhoXacNhanDialog;
        }(Serenity.PropertyDialog));
        POExcelUpdateThongTinKhoXacNhanDialog = __decorate([
            Serenity.Decorators.registerClass()
        ], POExcelUpdateThongTinKhoXacNhanDialog);
        BookingVcmReport.POExcelUpdateThongTinKhoXacNhanDialog = POExcelUpdateThongTinKhoXacNhanDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POUpdateDeliveryDateDialog = (function (_super) {
            __extends(POUpdateDeliveryDateDialog, _super);
            function POUpdateDeliveryDateDialog(po) {
                var _this = _super.call(this) || this;
                _this.po = po;
                _this.form = new BookingVcmReport.POUpdateDeliveryDateForm(_this.idPrefix);
                _this.form.DeliveryDate.value = Date.now().toString();
                return _this;
            }
            POUpdateDeliveryDateDialog.prototype.getDialogTitle = function () {
                return "Cập nhật ngày phát";
            };
            POUpdateDeliveryDateDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: "Kiểm tra",
                        click: function () {
                            BookingVcmReport.CssVcmDanhSachPoService.GetNumberOfPoDeliveryOnThisDay({
                                DeliveryDate: _this.form.DeliveryDate.value,
                                Keys: []
                            }, function (response) {
                                _this.form.PODeliveryOnDay.value = String(response);
                            });
                        }
                    },
                    {
                        ...
                        click: function () {
                            if (!_this.validateBeforeSave())
                                return;
                            BookingVcmReport.CssVcmDanhSachPoService.UpdateDeliveryDate({
                                DeliveryDate: _this.form.DeliveryDate.value,
                                Keys: _this.po,
                                Note: _this.form.Note.value
                            }, function (response) {
                                Q.notifyInfo("Đã cập nhật thành công ngày phát cho " + (response.Updated || 0) + " PO");
                                if (response.ErrorList != null && response.ErrorList.length > 0) {
            ...
            return POUpdateDeliveryDateDialog;
        }(Serenity.PropertyDialog));
        POUpdateDeliveryDateDialog = __decorate([
            Serenity.Decorators.registerClass()
        ], POUpdateDeliveryDateDialog);
        BookingVcmReport.POUpdateDeliveryDateDialog = POUpdateDeliveryDateDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoChartInPanel = (function (_super) {
            __extends(CssVcmDanhSachPoChartInPanel, _super);
            function CssVcmDanhSachPoChartInPanel(container) {
                var _this = _super.call(this, container) || this;
                BookingVcmReport.CssVcmDanhSachPoChartService.CssVcmDanhSachPoGetDataChart({}, function (response) {
                    _this.areaChart = new Morris.Bar({
                        element: _this.idPrefix + 'Chart',
                        resize: true, parseTime: false,
                        data: response.Values,
                        xkey: 'Day',
            ...
            CssVcmDanhSachPoChartInPanel.prototype.arrange = function () {
                _super.prototype.arrange.call(this);
                this.areaChart && this.areaChart.redraw();
            };
            CssVcmDanhSachPoChartInPanel.prototype.getTemplate = function () {
                // you could also put this in a ChartInDialog.Template.html file. it's here for simplicity.
                return "<div id='~_Chart'></div>";
            };
            return CssVcmDanhSachPoChartInPanel;
        }(Serenity.TemplatedPanel));
        CssVcmDanhSachPoChartInPanel = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.resizable(),
            Serenity.Decorators.maximizable()
        ], CssVcmDanhSachPoChartInPanel);
        BookingVcmReport.CssVcmDanhSachPoChartInPanel = CssVcmDanhSachPoChartInPanel;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDetDialog = (function (_super) {
            __extends(CssVcmDanhSachPoDetDialog, _super);
            function CssVcmDanhSachPoDetDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new BookingVcmReport.CssVcmDanhSachPoDetForm(_this.idPrefix);
                return _this;
            }
            CssVcmDanhSachPoDetDialog.prototype.getFormKey = function () { return BookingVcmReport.CssVcmDanhSachPoDetForm.formKey; };
            CssVcmDanhSachPoDetDialog.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.idProperty; };
            CssVcmDanhSachPoDetDialog.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.localTextPrefix; };
            CssVcmDanhSachPoDetDialog.prototype.getNameProperty = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.nameProperty; };
            CssVcmDanhSachPoDetDialog.prototype.getService = function () { return BookingVcmReport.CssVcmDanhSachPoDetService.baseUrl; };
            return CssVcmDanhSachPoDetDialog;
        }(Serenity.EntityDialog));
        CssVcmDanhSachPoDetDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CssVcmDanhSachPoDetDialog);
        BookingVcmReport.CssVcmDanhSachPoDetDialog = CssVcmDanhSachPoDetDialog;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDetEditor = (function (_super) {
            __extends(CssVcmDanhSachPoDetEditor, _super);
            function CssVcmDanhSachPoDetEditor(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoDetEditor.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmDanhSachPoDet'; };
            CssVcmDanhSachPoDetEditor.prototype.getDialogType = function () { return BookingVcmReport.CssVcmDanhSachPoDetDialog; };
            CssVcmDanhSachPoDetEditor.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.localTextPrefix; };
            CssVcmDanhSachPoDetEditor.prototype.getButtons = function () {
                return [];
            };
            return CssVcmDanhSachPoDetEditor;
        }(eLink.Common.GridEditorBase));
        CssVcmDanhSachPoDetEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoDetEditor);
        BookingVcmReport.CssVcmDanhSachPoDetEditor = CssVcmDanhSachPoDetEditor;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDetGrid = (function (_super) {
            __extends(CssVcmDanhSachPoDetGrid, _super);
            function CssVcmDanhSachPoDetGrid(container) {
                return _super.call(this, container) || this;
            }
            CssVcmDanhSachPoDetGrid.prototype.getColumnsKey = function () { return 'BookingVcmReport.CssVcmDanhSachPoDet'; };
            CssVcmDanhSachPoDetGrid.prototype.getDialogType = function () { return BookingVcmReport.CssVcmDanhSachPoDetDialog; };
            CssVcmDanhSachPoDetGrid.prototype.getIdProperty = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.idProperty; };
            CssVcmDanhSachPoDetGrid.prototype.getLocalTextPrefix = function () { return BookingVcmReport.CssVcmDanhSachPoDetRow.localTextPrefix; };
            CssVcmDanhSachPoDetGrid.prototype.getService = function () { return BookingVcmReport.CssVcmDanhSachPoDetService.baseUrl; };
            return CssVcmDanhSachPoDetGrid;
        }(Serenity.EntityGrid));
        CssVcmDanhSachPoDetGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CssVcmDanhSachPoDetGrid);
        BookingVcmReport.CssVcmDanhSachPoDetGrid = CssVcmDanhSachPoDetGrid;
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    ...
    eLink.BasicProgressDialog = BasicProgressDialog;
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new eLink.BasicProgressDialog();
...
(function (eLink) {
    ...
    })(DialogUtils = eLink.DialogUtils || (eLink.DialogUtils = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Common;
...
(function (eLink) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = eLink.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = eLink.LanguageList || (eLink.LanguageList = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Common;
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return eLink.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = eLink.BasicSamples || (eLink.BasicSamples = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return eLink.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = eLink.BasicSamples || (eLink.BasicSamples = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return eLink.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return eLink.StaticTextBlock; }], ['FromLocalText', function () { return eLink.StaticTextBlock; }], ['DisplayFieldValue', function () { return eLink.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = eLink.BasicSamples || (eLink.BasicSamples = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDanhSachPOSapNhanService;
        (function (CssVcmBaoCaoDanhSachPOSapNhanService) {
            CssVcmBaoCaoDanhSachPOSapNhanService.baseUrl = 'BookingVcmReport/CssVcmBaoCaoDanhSachPOSapNhan';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmBaoCaoDanhSachPOSapNhanService.Methods || (CssVcmBaoCaoDanhSachPOSapNhanService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CssVcmBaoCaoDanhSachPOSapNhanService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmBaoCaoDanhSachPOSapNhanService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmBaoCaoDanhSachPOSapNhanService.baseUrl + '/' + x;
            });
        })(CssVcmBaoCaoDanhSachPOSapNhanService = BookingVcmReport.CssVcmBaoCaoDanhSachPOSapNhanService || (BookingVcmReport.CssVcmBaoCaoDanhSachPOSapNhanService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangKheThoiGianForm = (function (_super) {
            __extends(CssVcmBaoCaoDatHangKheThoiGianForm, _super);
            function CssVcmBaoCaoDatHangKheThoiGianForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return CssVcmBaoCaoDatHangKheThoiGianForm;
        }(Serenity.PrefixedContext));
        CssVcmBaoCaoDatHangKheThoiGianForm.formKey = 'BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGian';
        BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianForm = CssVcmBaoCaoDatHangKheThoiGianForm;
        [['NgayGiao', function () { return Serenity.DateEditor; }], ['KheThoiGian', function () { return Serenity.StringEditor; }], ['SoLuong', function () { return Serenity.IntegerEditor; }], ['SoLuongToiDa', function () { return Serenity.IntegerEditor; }], ['ChenhLech', function () { return Serenity.IntegerEditor; }], ['GioGiao', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(CssVcmBaoCaoDatHangKheThoiGianForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangKheThoiGianRow;
        (function (CssVcmBaoCaoDatHangKheThoiGianRow) {
            CssVcmBaoCaoDatHangKheThoiGianRow.idProperty = 'Id';
            CssVcmBaoCaoDatHangKheThoiGianRow.nameProperty = 'KheThoiGian';
            CssVcmBaoCaoDatHangKheThoiGianRow.localTextPrefix = 'BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGian';
            var Fields;
            (function (Fields) {
            })(Fields = CssVcmBaoCaoDatHangKheThoiGianRow.Fields || (CssVcmBaoCaoDatHangKheThoiGianRow.Fields = {}));
            ['Id', 'NgayGiao', 'GioGiao', 'KheThoiGian', 'SoLuong', 'SoLuongToiDa', 'ChenhLech', 'FromTime', 'ToTime', 'DayOfWeek', 'EqualFromTime', 'EqualToTime'].forEach(function (x) { return Fields[x] = x; });
        })(CssVcmBaoCaoDatHangKheThoiGianRow = BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianRow || (BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianRow = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangKheThoiGianService;
        (function (CssVcmBaoCaoDatHangKheThoiGianService) {
            CssVcmBaoCaoDatHangKheThoiGianService.baseUrl = 'BookingVcmReport/CssVcmBaoCaoDatHangKheThoiGian';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmBaoCaoDatHangKheThoiGianService.Methods || (CssVcmBaoCaoDatHangKheThoiGianService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'getListKheThoiGianAll', 'getListKheThoiGian', 'getKheThoiGian'].forEach(function (x) {
                CssVcmBaoCaoDatHangKheThoiGianService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmBaoCaoDatHangKheThoiGianService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmBaoCaoDatHangKheThoiGianService.baseUrl + '/' + x;
            });
        })(CssVcmBaoCaoDatHangKheThoiGianService = BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianService || (BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGianService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangThangForm = (function (_super) {
            __extends(CssVcmBaoCaoDatHangThangForm, _super);
            function CssVcmBaoCaoDatHangThangForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return CssVcmBaoCaoDatHangThangForm;
        }(Serenity.PrefixedContext));
        CssVcmBaoCaoDatHangThangForm.formKey = 'BookingVcmReport.CssVcmBaoCaoDatHangThang';
        BookingVcmReport.CssVcmBaoCaoDatHangThangForm = CssVcmBaoCaoDatHangThangForm;
        [['NgayDatHang', function () { return Serenity.DateEditor; }], ['NgayThucNhan', function () { return Serenity.DateEditor; }], ['SkuKeHoach', function () { return Serenity.IntegerEditor; }], ['UnitKeHoach', function () { return Serenity.IntegerEditor; }], ['SkuThucNhan', function () { return Serenity.IntegerEditor; }], ['UnitThucNhan', function () { return Serenity.IntegerEditor; }], ['SkuChenhLech', function () { return Serenity.IntegerEditor; }], ['UnitChenhLech', function () { return Serenity.IntegerEditor; }], ['SkuTiLe', function () { return Serenity.DecimalEditor; }], ['UnitTiLe', function () { return Serenity.DecimalEditor; }], ['DeliveryInFullGrade', function () { return Serenity.StringEditor; }], ['DeliveryInTimeGrade', function () { return Serenity.StringEditor; }], ['GioGiao', function () { return Serenity.DateEditor; }], ['GioNhanThucTe', function () { return Serenity.DateEditor; }], ['ThoiGianTre', function () { return Serenity.StringEditor; }], ['GhiChuHenGiao', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(CssVcmBaoCaoDatHangThangForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangThangRow;
        (function (CssVcmBaoCaoDatHangThangRow) {
            CssVcmBaoCaoDatHangThangRow.idProperty = 'Id';
            CssVcmBaoCaoDatHangThangRow.nameProperty = 'MaPo';
            CssVcmBaoCaoDatHangThangRow.localTextPrefix = 'BookingVcmReport.CssVcmBaoCaoDatHangThang';
            var Fields;
            (function (Fields) {
            })(Fields = CssVcmBaoCaoDatHangThangRow.Fields || (CssVcmBaoCaoDatHangThangRow.Fields = {}));
            ['Id', 'MaPo', 'NgayDatHang', 'NgayThucNhan', 'SkuKeHoach', 'UnitKeHoach', 'SkuThucNhan', 'UnitThucNhan', 'SkuChenhLech', 'UnitChenhLech', 'SkuTiLe', 'UnitTiLe', 'DeliveryInFullGrade', 'GioGiao', 'GioNhanThucTe', 'ThoiGianTre', 'GhiChuHenGiao', 'DeliveryInTimeGrade', 'Vendor', 'Vendor_SupplyingSite'].forEach(function (x) { return Fields[x] = x; });
        })(CssVcmBaoCaoDatHangThangRow = BookingVcmReport.CssVcmBaoCaoDatHangThangRow || (BookingVcmReport.CssVcmBaoCaoDatHangThangRow = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoDatHangThangService;
        (function (CssVcmBaoCaoDatHangThangService) {
            CssVcmBaoCaoDatHangThangService.baseUrl = 'BookingVcmReport/CssVcmBaoCaoDatHangThang';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmBaoCaoDatHangThangService.Methods || (CssVcmBaoCaoDatHangThangService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CssVcmBaoCaoDatHangThangService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmBaoCaoDatHangThangService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmBaoCaoDatHangThangService.baseUrl + '/' + x;
            });
        })(CssVcmBaoCaoDatHangThangService = BookingVcmReport.CssVcmBaoCaoDatHangThangService || (BookingVcmReport.CssVcmBaoCaoDatHangThangService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoNCCForm = (function (_super) {
            __extends(CssVcmBaoCaoNCCForm, _super);
            function CssVcmBaoCaoNCCForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return CssVcmBaoCaoNCCForm;
        }(Serenity.PrefixedContext));
        CssVcmBaoCaoNCCForm.formKey = 'BookingVcmReport.CssVcmBaoCaoNCC';
        BookingVcmReport.CssVcmBaoCaoNCCForm = CssVcmBaoCaoNCCForm;
        [['Vendor', function () { return Serenity.StringEditor; }], ['Vendor_SupplyingSite', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(CssVcmBaoCaoNCCForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoNCCRow;
        (function (CssVcmBaoCaoNCCRow) {
            CssVcmBaoCaoNCCRow.idProperty = 'Id';
            CssVcmBaoCaoNCCRow.nameProperty = 'Vendor';
            CssVcmBaoCaoNCCRow.localTextPrefix = 'BookingVcmReport.CssVcmBaoCaoNCC';
            var Fields;
            (function (Fields) {
            })(Fields = CssVcmBaoCaoNCCRow.Fields || (CssVcmBaoCaoNCCRow.Fields = {}));
            ['Id', 'Vendor', 'Vendor_SupplyingSite'].forEach(function (x) { return Fields[x] = x; });
        })(CssVcmBaoCaoNCCRow = BookingVcmReport.CssVcmBaoCaoNCCRow || (BookingVcmReport.CssVcmBaoCaoNCCRow = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmBaoCaoNCCService;
        (function (CssVcmBaoCaoNCCService) {
            CssVcmBaoCaoNCCService.baseUrl = 'BookingVcmReport/CssVcmBaoCaoNCC';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmBaoCaoNCCService.Methods || (CssVcmBaoCaoNCCService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CssVcmBaoCaoNCCService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmBaoCaoNCCService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmBaoCaoNCCService.baseUrl + '/' + x;
            });
        })(CssVcmBaoCaoNCCService = BookingVcmReport.CssVcmBaoCaoNCCService || (BookingVcmReport.CssVcmBaoCaoNCCService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoChartService;
        (function (CssVcmDanhSachPoChartService) {
            CssVcmDanhSachPoChartService.baseUrl = 'BookingVcmReport/CssVcmDanhSachPoChart';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmDanhSachPoChartService.Methods || (CssVcmDanhSachPoChartService.Methods = {}));
            ['CssVcmDanhSachPoGetDataChart'].forEach(function (x) {
                CssVcmDanhSachPoChartService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmDanhSachPoChartService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmDanhSachPoChartService.baseUrl + '/' + x;
            });
        })(CssVcmDanhSachPoChartService = BookingVcmReport.CssVcmDanhSachPoChartService || (BookingVcmReport.CssVcmDanhSachPoChartService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDetForm = (function (_super) {
            __extends(CssVcmDanhSachPoDetForm, _super);
            function CssVcmDanhSachPoDetForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return CssVcmDanhSachPoDetForm;
        }(Serenity.PrefixedContext));
        CssVcmDanhSachPoDetForm.formKey = 'BookingVcmReport.CssVcmDanhSachPoDet';
        BookingVcmReport.CssVcmDanhSachPoDetForm = CssVcmDanhSachPoDetForm;
        [['OrderQuantity', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(CssVcmDanhSachPoDetForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDetRow;
        (function (CssVcmDanhSachPoDetRow) {
            CssVcmDanhSachPoDetRow.idProperty = 'Id';
            CssVcmDanhSachPoDetRow.nameProperty = 'MaPo';
            CssVcmDanhSachPoDetRow.localTextPrefix = 'BookingVcmReport.CssVcmDanhSachPoDet';
            var Fields;
            (function (Fields) {
            })(Fields = CssVcmDanhSachPoDetRow.Fields || (CssVcmDanhSachPoDetRow.Fields = {}));
            ['Id', 'MaPo', 'DocumentDate', 'Vendor', 'VendorSupplyingSite', 'Item', 'Article', 'ShortText', 'OrderQuantity', 'OrderUnit', 'Ctns', 'Weight', 'Cbm', 'NameOfUploader', 'TelofUploader', 'Note', 'InsertDate', 'InsertTime', 'InsertUser', 'UpdateDate', 'UpdateTime', 'UpdateUser', 'NvLaiXe', 'SdtNvLaiXe', 'BienSoXe', 'SoLuongUpload', 'NgaySanXuat', 'NgayHetHan', 'SoLuongNccHenGiao', 'SoLuongThucNhan', 'NgayNhanThucTe', 'GioNhanThucTe', 'GTIN', 'MerchandiseCategory'].forEach(function (x) { return Fields[x] = x; });
        })(CssVcmDanhSachPoDetRow = BookingVcmReport.CssVcmDanhSachPoDetRow || (BookingVcmReport.CssVcmDanhSachPoDetRow = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoDetService;
        (function (CssVcmDanhSachPoDetService) {
            CssVcmDanhSachPoDetService.baseUrl = 'BookingVcmReport/CssVcmDanhSachPoDet';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmDanhSachPoDetService.Methods || (CssVcmDanhSachPoDetService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CssVcmDanhSachPoDetService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmDanhSachPoDetService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmDanhSachPoDetService.baseUrl + '/' + x;
            });
        })(CssVcmDanhSachPoDetService = BookingVcmReport.CssVcmDanhSachPoDetService || (BookingVcmReport.CssVcmDanhSachPoDetService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoForm = (function (_super) {
            __extends(CssVcmDanhSachPoForm, _super);
            function CssVcmDanhSachPoForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return CssVcmDanhSachPoForm;
        }(Serenity.PrefixedContext));
        CssVcmDanhSachPoForm.formKey = 'BookingVcmReport.CssVcmDanhSachPo';
        BookingVcmReport.CssVcmDanhSachPoForm = CssVcmDanhSachPoForm;
        [].forEach(function (x) { return Object.defineProperty(CssVcmDanhSachPoForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoRow;
        (function (CssVcmDanhSachPoRow) {
            CssVcmDanhSachPoRow.idProperty = 'MaPo';
            CssVcmDanhSachPoRow.nameProperty = 'MaPo';
            CssVcmDanhSachPoRow.localTextPrefix = 'BookingVcmReport.CssVcmDanhSachPo';
            var Fields;
            (function (Fields) {
            })(Fields = CssVcmDanhSachPoRow.Fields || (CssVcmDanhSachPoRow.Fields = {}));
            ['Id', 'MaPo', 'NgayGiao', 'Vendor', 'VendorSupplyingSite', 'GhiChu', 'InsertDate', 'InsertTime', 'InsertUser', 'InsertUserName', 'UpdateDate', 'UpdateTime', 'UpdateUser', 'UpdateUserName', 'TrangThai', 'GioGiao', 'GhiChuHenGiao', 'GhiChuTuChoi', 'TenTrangThai', 'NvLaiXe', 'SdtNvLaiXe', 'BienSoXe', 'Quantity', 'NgayNhanThucTe', 'GioNhanThucTe', 'SLKhungThoiGianDaXacNhan', 'Site', 'DeliveryDate', 'ReleaseStrategy'].forEach(function (x) { return Fields[x] = x; });
        })(CssVcmDanhSachPoRow = BookingVcmReport.CssVcmDanhSachPoRow || (BookingVcmReport.CssVcmDanhSachPoRow = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var CssVcmDanhSachPoService;
        (function (CssVcmDanhSachPoService) {
            CssVcmDanhSachPoService.baseUrl = 'BookingVcmReport/CssVcmDanhSachPo';
            var Methods;
            (function (Methods) {
            })(Methods = CssVcmDanhSachPoService.Methods || (CssVcmDanhSachPoService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'ExcelImport', 'ExcelUpdate', 'ExcelUpdateThongTinKhoXacNhan', 'UpdateStatus', 'GetNumberOfPo', 'GetNumberOfPoDeliveryOnThisDay', 'UpdateDeliveryDate', 'ValidateXacNhanKhoXacNhanLichGiao', 'ConfirmWarehouseStatus', 'DenyWarehouseStatus', 'DeletePO', 'KhoHuyLichDonHang', 'getListStringColumnsThuTuXapXep', 'getThongTinDonHangTheoMaPO', 'getDicEmailTheoMaNCC'].forEach(function (x) {
                CssVcmDanhSachPoService[x] = function (r, s, o) { return Q.serviceRequest(CssVcmDanhSachPoService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CssVcmDanhSachPoService.baseUrl + '/' + x;
            });
        })(CssVcmDanhSachPoService = BookingVcmReport.CssVcmDanhSachPoService || (BookingVcmReport.CssVcmDanhSachPoService = {}));
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var KhoHuyLichDonHangForm = (function (_super) {
            __extends(KhoHuyLichDonHangForm, _super);
            function KhoHuyLichDonHangForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return KhoHuyLichDonHangForm;
        }(Serenity.PrefixedContext));
        KhoHuyLichDonHangForm.formKey = 'BookingVcmReport.KhoHuyLichDonHang';
        BookingVcmReport.KhoHuyLichDonHangForm = KhoHuyLichDonHangForm;
        [['Note', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(KhoHuyLichDonHangForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var PODenyWarehouseStatusForm = (function (_super) {
            __extends(PODenyWarehouseStatusForm, _super);
            function PODenyWarehouseStatusForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return PODenyWarehouseStatusForm;
        }(Serenity.PrefixedContext));
        PODenyWarehouseStatusForm.formKey = 'BookingVcmReport.PODenyWarehouseStatus';
        BookingVcmReport.PODenyWarehouseStatusForm = PODenyWarehouseStatusForm;
        [['Note', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(PODenyWarehouseStatusForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POExcelImportForm = (function (_super) {
            __extends(POExcelImportForm, _super);
            function POExcelImportForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return POExcelImportForm;
        }(Serenity.PrefixedContext));
        POExcelImportForm.formKey = 'BookingVcmReport.POExcelImport';
        BookingVcmReport.POExcelImportForm = POExcelImportForm;
        [['FileName', function () { return Serenity.ImageUploadEditor; }]].forEach(function (x) { return Object.defineProperty(POExcelImportForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POExcelUpdateForm = (function (_super) {
            __extends(POExcelUpdateForm, _super);
            function POExcelUpdateForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return POExcelUpdateForm;
        }(Serenity.PrefixedContext));
        POExcelUpdateForm.formKey = 'BookingVcmReport.POExcelUpdate';
        BookingVcmReport.POExcelUpdateForm = POExcelUpdateForm;
        [['FileName', function () { return Serenity.ImageUploadEditor; }]].forEach(function (x) { return Object.defineProperty(POExcelUpdateForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POExcelUpdateThongTinKhoXacNhanForm = (function (_super) {
            __extends(POExcelUpdateThongTinKhoXacNhanForm, _super);
            function POExcelUpdateThongTinKhoXacNhanForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return POExcelUpdateThongTinKhoXacNhanForm;
        }(Serenity.PrefixedContext));
        POExcelUpdateThongTinKhoXacNhanForm.formKey = 'BookingVcmReport.POExcelUpdateThongTinKhoXacNhan';
        BookingVcmReport.POExcelUpdateThongTinKhoXacNhanForm = POExcelUpdateThongTinKhoXacNhanForm;
        [['FileName', function () { return Serenity.ImageUploadEditor; }]].forEach(function (x) { return Object.defineProperty(POExcelUpdateThongTinKhoXacNhanForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var BookingVcmReport;
    (function (BookingVcmReport) {
        var POUpdateDeliveryDateForm = (function (_super) {
            __extends(POUpdateDeliveryDateForm, _super);
            function POUpdateDeliveryDateForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return POUpdateDeliveryDateForm;
        }(Serenity.PrefixedContext));
        POUpdateDeliveryDateForm.formKey = 'BookingVcmReport.POUpdateDeliveryDate';
        BookingVcmReport.POUpdateDeliveryDateForm = POUpdateDeliveryDateForm;
        [['DeliveryDate', function () { return Serenity.DateTimeEditor; }], ['PODeliveryOnDay', function () { return Serenity.StringEditor; }], ['Note', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(POUpdateDeliveryDateForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BookingVcmReport = eLink.BookingVcmReport || (eLink.BookingVcmReport = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    ...
    })(Membership = eLink.Membership || (eLink.Membership = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Membership;
...
(function (eLink) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'eLink.Northwind.Entities.Gender');
    })(Northwind = eLink.Northwind || (eLink.Northwind = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    ...
    (function (Northwind) {
        ...
        [['DetailList', function () { return Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(OrderForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Northwind = eLink.Northwind || (eLink.Northwind = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    ...
    (function (QuanLyHocSinh) {
        var QuanLyHocSinhForm = (function (_super) {
            __extends(QuanLyHocSinhForm, _super);
            function QuanLyHocSinhForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return QuanLyHocSinhForm;
        }(Serenity.PrefixedContext));
        QuanLyHocSinhForm.formKey = 'QuanLyHocSinh.QuanLyHocSinh';
        QuanLyHocSinh.QuanLyHocSinhForm = QuanLyHocSinhForm;
        [['MaHs', function () { return Serenity.StringEditor; }], ['TenHs', function () { return Serenity.StringEditor; }], ['InsertDate', function () { return Serenity.DateEditor; }], ['InsertTime', function () { return Serenity.DateEditor; }], ['InsertUser', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(QuanLyHocSinhForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(QuanLyHocSinh = eLink.QuanLyHocSinh || (eLink.QuanLyHocSinh = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var QuanLyHocSinh;
    (function (QuanLyHocSinh) {
        var QuanLyHocSinhRow;
        (function (QuanLyHocSinhRow) {
            QuanLyHocSinhRow.idProperty = 'Id';
            QuanLyHocSinhRow.nameProperty = 'MaHs';
            QuanLyHocSinhRow.localTextPrefix = 'QuanLyHocSinh.QuanLyHocSinh';
            var Fields;
            (function (Fields) {
            })(Fields = QuanLyHocSinhRow.Fields || (QuanLyHocSinhRow.Fields = {}));
            ['Id', 'MaHs', 'TenHs', 'InsertDate', 'InsertTime', 'InsertUser'].forEach(function (x) { return Fields[x] = x; });
        })(QuanLyHocSinhRow = QuanLyHocSinh.QuanLyHocSinhRow || (QuanLyHocSinh.QuanLyHocSinhRow = {}));
    })(QuanLyHocSinh = eLink.QuanLyHocSinh || (eLink.QuanLyHocSinh = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var QuanLyHocSinh;
    (function (QuanLyHocSinh) {
        var QuanLyHocSinhService;
        (function (QuanLyHocSinhService) {
            QuanLyHocSinhService.baseUrl = 'QuanLyHocSinh/QuanLyHocSinh';
            var Methods;
            (function (Methods) {
            })(Methods = QuanLyHocSinhService.Methods || (QuanLyHocSinhService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                QuanLyHocSinhService[x] = function (r, s, o) { return Q.serviceRequest(QuanLyHocSinhService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = QuanLyHocSinhService.baseUrl + '/' + x;
            });
        })(QuanLyHocSinhService = QuanLyHocSinh.QuanLyHocSinhService || (QuanLyHocSinh.QuanLyHocSinhService = {}));
    })(QuanLyHocSinh = eLink.QuanLyHocSinh || (eLink.QuanLyHocSinh = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
...
(function (eLink) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('eLink');
    })(ScriptInitialization = eLink.ScriptInitialization || (eLink.ScriptInitialization = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var Common;
                ...
                _this.byId('LoginButton').click(function (e) {
                    ...
                    Q.serviceCall({
                        ...
                        onSuccess: function (response) {
                            ...
                            if (returnUrl) {
                                Q.confirm("· Thông báo gửi hàng phải được gửi cho Kho Trung Chuyển trước 15:00 PM vào các ngày làm việc. (Ngày làm việc: Thứ Hai - Thứ Bảy trừ Chủ Nhật và Ngày Lễ)\r\n"
                                    ...
                                    + "· Kho Trung Chuyển sẽ không nhận hàng mà không có Thông báo gửi hàng có xác nhận của Kho Trung Chuyển hoặc có Thông báo gửi hàng mà không có xác nhận của Kho Trung Chuyển.", function () {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: eLink.Authorization.userDefinition.DisplayName,
...
(function (eLink) {
    ...
    (function (BasicSamples) {
        ...
        }(eLink.Common.BulkServiceAction));
...
(function (eLink) {
    var QuanLyHocSinh;
    (function (QuanLyHocSinh) {
        var QuanLyHocSinhDialog = (function (_super) {
            __extends(QuanLyHocSinhDialog, _super);
            function QuanLyHocSinhDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new QuanLyHocSinh.QuanLyHocSinhForm(_this.idPrefix);
                return _this;
            }
            QuanLyHocSinhDialog.prototype.getFormKey = function () { return QuanLyHocSinh.QuanLyHocSinhForm.formKey; };
            QuanLyHocSinhDialog.prototype.getIdProperty = function () { return QuanLyHocSinh.QuanLyHocSinhRow.idProperty; };
            QuanLyHocSinhDialog.prototype.getLocalTextPrefix = function () { return QuanLyHocSinh.QuanLyHocSinhRow.localTextPrefix; };
            QuanLyHocSinhDialog.prototype.getNameProperty = function () { return QuanLyHocSinh.QuanLyHocSinhRow.nameProperty; };
            QuanLyHocSinhDialog.prototype.getService = function () { return QuanLyHocSinh.QuanLyHocSinhService.baseUrl; };
            QuanLyHocSinhDialog.prototype.getDialogTitle = function () {
                return "Thêm học sinh";
            };
            QuanLyHocSinhDialog.prototype.getToolbarButtons = function () {
                var buttons = [];
                buttons.pop();
                return buttons;
            };
            return QuanLyHocSinhDialog;
        }(Serenity.EntityDialog));
        QuanLyHocSinhDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], QuanLyHocSinhDialog);
        QuanLyHocSinh.QuanLyHocSinhDialog = QuanLyHocSinhDialog;
    })(QuanLyHocSinh = eLink.QuanLyHocSinh || (eLink.QuanLyHocSinh = {}));
})(eLink || (eLink = {}));
var eLink;
(function (eLink) {
    var QuanLyHocSinh;
    (function (QuanLyHocSinh) {
        var QuanLyHocSinhGrid = (function (_super) {
            __extends(QuanLyHocSinhGrid, _super);
            function QuanLyHocSinhGrid(container) {
                return _super.call(this, container) || this;
            }
            QuanLyHocSinhGrid.prototype.getColumnsKey = function () { return 'QuanLyHocSinh.QuanLyHocSinh'; };
            QuanLyHocSinhGrid.prototype.getDialogType = function () { return QuanLyHocSinh.QuanLyHocSinhDialog; };
            QuanLyHocSinhGrid.prototype.getIdProperty = function () { return QuanLyHocSinh.QuanLyHocSinhRow.idProperty; };
            QuanLyHocSinhGrid.prototype.getLocalTextPrefix = function () { return QuanLyHocSinh.QuanLyHocSinhRow.localTextPrefix; };
            QuanLyHocSinhGrid.prototype.getService = function () { return QuanLyHocSinh.QuanLyHocSinhService.baseUrl; };
            QuanLyHocSinhGrid.prototype.getButtons = function () {
                var buttons = [];
                buttons.push({
                    title: "Thêm học sinh", cssClass: "add-button",
                    onClick: function () { var dialog = new QuanLyHocSinh.QuanLyHocSinhDialog(); dialog.dialogOpen(); }
                });
                return buttons;
            };
            return QuanLyHocSinhGrid;
        }(Serenity.EntityGrid));
        QuanLyHocSinhGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], QuanLyHocSinhGrid);
        QuanLyHocSinh.QuanLyHocSinhGrid = QuanLyHocSinhGrid;
    })(QuanLyHocSinh = eLink.QuanLyHocSinh || (eLink.QuanLyHocSinh = {}));
})(eLink || (eLink = {}));
//# sourceMappingURL=eLink.Web.js.map