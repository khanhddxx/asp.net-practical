declare namespace eLink.Administration {
...
declare namespace eLink.Authorization {
...
declare namespace eLink.BasicSamples {
...
declare namespace eLink.Northwind {
...
declare namespace eLink.BasicSamples.DialogBoxes {
...
declare namespace eLink.Common {
...
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoDanhSachPOSapNhanGrid extends Serenity.EntityGrid<CssVcmDanhSachPoRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): any;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        ...
        protected createToolbarExtensions(): void;
        protected getButtons(): Serenity.ToolButton[];
        protected createQuickSearchInput(): any;
    }
}
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoDatHangKheThoiGianGrid extends Serenity.EntityGrid<CssVcmBaoCaoDatHangKheThoiGianRow, any> {
        protected getColumnsKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoDatHangThangDialog extends Serenity.EntityDialog<CssVcmBaoCaoDatHangThangRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: CssVcmBaoCaoDatHangThangForm;
    }
}
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoDatHangThangGrid extends Serenity.EntityGrid<CssVcmBaoCaoDatHangThangRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof CssVcmBaoCaoDatHangThangDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
...
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoNCCDialog extends Serenity.EntityDialog<CssVcmBaoCaoNCCRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: CssVcmBaoCaoNCCForm;
    }
}
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoNCCGrid extends Serenity.EntityGrid<CssVcmBaoCaoNCCRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof CssVcmBaoCaoNCCDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoCssVcmDanhSachPoDetDialog extends Serenity.EntityDialog<CssVcmDanhSachPoDetRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: CssVcmDanhSachPoDetForm;
        constructor();
    }
}
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoCssVcmDanhSachPoDetGrid extends Serenity.EntityGrid<CssVcmDanhSachPoDetRow, any> {
        protected getColumnsKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoDialog extends Serenity.EntityDialog<CssVcmDanhSachPoRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: CssVcmDanhSachPoForm;
        private CssVcmDanhSachPoDetGrid;
        private loadedState;
        constructor();
        protected afterLoadEntity(): void;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoEditor extends Common.GridEditorBase<CssVcmDanhSachPoRow> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof CssVcmDanhSachPoDialog;
        protected getLocalTextPrefix(): string;
        constructor(container: JQuery);
    }
}
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoGrid extends Serenity.EntityGrid<CssVcmDanhSachPoRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): any;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoGrid_KhoUpDS extends CssVcmDanhSachPoGrid {
        constructor(container: JQuery);
        protected createToolbarExtensions(): void;
        protected getButtons(): Serenity.ToolButton[];
    }
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoGrid_KhoXacNhanGiao extends CssVcmDanhSachPoGrid {
        protected getColumnsKey(): string;
        constructor(container: JQuery);
        protected createToolbarExtensions(): void;
        protected getButtons(): Serenity.ToolButton[];
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoGrid_NCCHenGiao extends CssVcmDanhSachPoGrid {
        constructor(container: JQuery);
        protected createToolbarExtensions(): void;
        protected getButtons(): Serenity.ToolButton[];
    }
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoGrid_ThongTinKhoDaXacNhan extends CssVcmDanhSachPoGrid {
        constructor(container: JQuery);
        protected createToolbarExtensions(): void;
        protected getButtons(): Serenity.ToolButton[];
    }
...
declare namespace eLink.BookingVcmReport {
    class KhoHuyLichDonHangDialog extends Serenity.PropertyDialog<any, any> {
        private form;
        private po;
...
declare namespace eLink.BookingVcmReport {
    class PODenyWarehouseStatusDialog extends Serenity.PropertyDialog<any, any> {
        private form;
        private po;
        constructor(po: string[]);
        protected getDialogTitle(): string;
...
declare namespace eLink.BookingVcmReport {
    class POExcelImportDialog extends Serenity.PropertyDialog<any, any> {
        private form;
        constructor();
        protected getDialogTitle(): string;
        protected getDialogButtons(): Serenity.DialogButton[];
...
declare namespace eLink.BookingVcmReport {
    class POExcelUpdateDialog extends Serenity.PropertyDialog<any, any> {
        private form;
        constructor();
        protected getDialogTitle(): string;
        protected getDialogButtons(): Serenity.DialogButton[];
...
declare namespace eLink.BookingVcmReport {
    class POExcelUpdateThongTinKhoXacNhanDialog extends Serenity.PropertyDialog<any, any> {
        private form;
        constructor();
        protected getDialogTitle(): string;
        protected getDialogButtons(): Serenity.DialogButton[];
...
declare namespace eLink.BookingVcmReport {
    class POUpdateDeliveryDateDialog extends Serenity.PropertyDialog<any, any> {
        private form;
        private po;
        constructor(po: string[]);
        protected getDialogTitle(): string;
...
declare var Morris: any;
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoChartInPanel extends Serenity.TemplatedPanel<any> {
        private areaChart;
        constructor(container: JQuery);
        protected arrange(): void;
        protected getTemplate(): string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoDetDialog extends Serenity.EntityDialog<CssVcmDanhSachPoDetRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoDetEditor extends Common.GridEditorBase<CssVcmDanhSachPoDetRow> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof CssVcmDanhSachPoDetDialog;
        protected getLocalTextPrefix(): string;
        constructor(container: JQuery);
        protected getButtons(): any[];
    }
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoDetGrid extends Serenity.EntityGrid<CssVcmDanhSachPoDetRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof CssVcmDanhSachPoDetDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
...
declare namespace eLink.DialogUtils {
...
declare namespace eLink.LanguageList {
...
declare namespace Serenity {
    interface BaseUpdateResponse extends Serenity.ServiceResponse {
        Updated?: number;
        ErrorList?: string[];
    }
}
...
declare namespace eLink.BookingVcmReport {
    namespace CssVcmBaoCaoDanhSachPOSapNhanService {
        const baseUrl = "BookingVcmReport/CssVcmBaoCaoDanhSachPOSapNhan";
        function Create(request: Serenity.SaveRequest<CssVcmDanhSachPoRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CssVcmDanhSachPoRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CssVcmDanhSachPoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CssVcmDanhSachPoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoDatHangKheThoiGianForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface CssVcmBaoCaoDatHangKheThoiGianForm {
...
declare namespace eLink.BookingVcmReport {
    interface CssVcmBaoCaoDatHangKheThoiGianRow {
        Id?: number;
        NgayGiao?: string;
        GioGiao?: string;
        KheThoiGian?: string;
    ...
    namespace CssVcmBaoCaoDatHangKheThoiGianRow {
        const idProperty = "Id";
        const nameProperty = "KheThoiGian";
        const localTextPrefix = "BookingVcmReport.CssVcmBaoCaoDatHangKheThoiGian";
        namespace Fields {
            const Id: string;
            const NgayGiao: string;
            const GioGiao: string;
            const KheThoiGian: string;
            const SoLuong: string;
            const SoLuongToiDa: string;
            const ChenhLech: string;
            const FromTime: string;
            const ToTime: string;
            const DayOfWeek: string;
            const EqualFromTime: string;
            const EqualToTime: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
    namespace CssVcmBaoCaoDatHangKheThoiGianService {
        const baseUrl = "BookingVcmReport/CssVcmBaoCaoDatHangKheThoiGian";
        function Create(request: Serenity.SaveRequest<CssVcmBaoCaoDatHangKheThoiGianRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CssVcmBaoCaoDatHangKheThoiGianRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CssVcmBaoCaoDatHangKheThoiGianRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CssVcmBaoCaoDatHangKheThoiGianRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function getListKheThoiGianAll(request: Serenity.ServiceRequest, onSuccess?: (response: System.Collections.Generic.IEnumerable<CssVcmBaoCaoDatHangKheThoiGianRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function getListKheThoiGian(request: System.DateTime, onSuccess?: (response: System.Collections.Generic.IEnumerable<CssVcmBaoCaoDatHangKheThoiGianRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function getKheThoiGian(request: System.DateTime, onSuccess?: (response: CssVcmBaoCaoDatHangKheThoiGianRow) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
            const Retrieve: string;
            const List: string;
            const getListKheThoiGianAll: string;
            const getListKheThoiGian: string;
            const getKheThoiGian: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
...
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoDatHangThangForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface CssVcmBaoCaoDatHangThangForm {
...
declare namespace eLink.BookingVcmReport {
    interface CssVcmBaoCaoDatHangThangRow {
        Id?: number;
        MaPo?: string;
        NgayDatHang?: string;
        NgayThucNhan?: string;
    ...
    namespace CssVcmBaoCaoDatHangThangRow {
        const idProperty = "Id";
        const nameProperty = "MaPo";
        const localTextPrefix = "BookingVcmReport.CssVcmBaoCaoDatHangThang";
        namespace Fields {
            const Id: string;
            const MaPo: string;
            const NgayDatHang: string;
            const NgayThucNhan: string;
            const SkuKeHoach: string;
            const UnitKeHoach: string;
            const SkuThucNhan: string;
            const UnitThucNhan: string;
            const SkuChenhLech: string;
            const UnitChenhLech: string;
            const SkuTiLe: string;
            const UnitTiLe: string;
            const DeliveryInFullGrade: string;
            const GioGiao: string;
            const GioNhanThucTe: string;
            const ThoiGianTre: string;
            const GhiChuHenGiao: string;
            const DeliveryInTimeGrade: string;
            const Vendor: string;
            const Vendor_SupplyingSite: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
    namespace CssVcmBaoCaoDatHangThangService {
        const baseUrl = "BookingVcmReport/CssVcmBaoCaoDatHangThang";
        function Create(request: Serenity.SaveRequest<CssVcmBaoCaoDatHangThangRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CssVcmBaoCaoDatHangThangRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CssVcmBaoCaoDatHangThangRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CssVcmBaoCaoDatHangThangRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmBaoCaoNCCForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface CssVcmBaoCaoNCCForm {
        Vendor: Serenity.StringEditor;
        Vendor_SupplyingSite: Serenity.StringEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    interface CssVcmBaoCaoNCCRow {
        Id?: number;
        Vendor?: string;
        Vendor_SupplyingSite?: string;
    }
    namespace CssVcmBaoCaoNCCRow {
        const idProperty = "Id";
        const nameProperty = "Vendor";
        const localTextPrefix = "BookingVcmReport.CssVcmBaoCaoNCC";
        namespace Fields {
            const Id: string;
            const Vendor: string;
            const Vendor_SupplyingSite: string;
...
declare namespace eLink.BookingVcmReport {
    namespace CssVcmBaoCaoNCCService {
        const baseUrl = "BookingVcmReport/CssVcmBaoCaoNCC";
        function Create(request: Serenity.SaveRequest<CssVcmBaoCaoNCCRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CssVcmBaoCaoNCCRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CssVcmBaoCaoNCCRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CssVcmBaoCaoNCCRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace eLink.BookingVcmReport {
    namespace CssVcmDanhSachPoChartService {
        const baseUrl = "BookingVcmReport/CssVcmDanhSachPoChart";
        function CssVcmDanhSachPoGetDataChart(request: Serenity.CssVcmDanhSachPoRequest, onSuccess?: (response: Serenity.CssVcmDanhSachPoResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const CssVcmDanhSachPoGetDataChart: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoDetForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface CssVcmDanhSachPoDetForm {
        OrderQuantity: Serenity.DecimalEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    interface CssVcmDanhSachPoDetRow {
        Id?: number;
        MaPo?: string;
        DocumentDate?: string;
        Vendor?: string;
    ...
    namespace CssVcmDanhSachPoDetRow {
        const idProperty = "Id";
        const nameProperty = "MaPo";
        const localTextPrefix = "BookingVcmReport.CssVcmDanhSachPoDet";
        namespace Fields {
            const Id: string;
            const MaPo: string;
            const DocumentDate: string;
            const Vendor: string;
            const VendorSupplyingSite: string;
            const Item: string;
            ...
            const Weight: string;
            const Cbm: string;
            const NameOfUploader: string;
            const TelofUploader: string;
            const Note: string;
            const InsertDate: string;
            const InsertTime: string;
            const InsertUser: string;
            const UpdateDate: string;
            const UpdateTime: string;
            const UpdateUser: string;
            const NvLaiXe: string;
            const SdtNvLaiXe: string;
            const BienSoXe: string;
            const SoLuongUpload: string;
            const NgaySanXuat: string;
            const NgayHetHan: string;
            const SoLuongNccHenGiao: string;
            const SoLuongThucNhan: string;
            const NgayNhanThucTe: string;
            const GioNhanThucTe: string;
            const GTIN: string;
            const MerchandiseCategory: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
    namespace CssVcmDanhSachPoDetService {
        const baseUrl = "BookingVcmReport/CssVcmDanhSachPoDet";
        function Create(request: Serenity.SaveRequest<CssVcmDanhSachPoDetRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CssVcmDanhSachPoDetRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CssVcmDanhSachPoDetRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CssVcmDanhSachPoDetRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace eLink.BookingVcmReport {
    class CssVcmDanhSachPoForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface CssVcmDanhSachPoForm {
    }
}
declare namespace eLink.BookingVcmReport {
}
declare namespace eLink.BookingVcmReport {
    interface CssVcmDanhSachPoRow {
        Id?: number;
        MaPo?: string;
        NgayGiao?: string;
        Vendor?: string;
    ...
    namespace CssVcmDanhSachPoRow {
        const idProperty = "MaPo";
        const nameProperty = "MaPo";
        const localTextPrefix = "BookingVcmReport.CssVcmDanhSachPo";
        namespace Fields {
            const Id: string;
            const MaPo: string;
            const NgayGiao: string;
            ...
            const GioGiao: string;
            const GhiChuHenGiao: string;
            const GhiChuTuChoi: string;
            const TenTrangThai: string;
            const NvLaiXe: string;
            const SdtNvLaiXe: string;
            const BienSoXe: string;
            ...
            const NgayNhanThucTe: string;
            const GioNhanThucTe: string;
            const SLKhungThoiGianDaXacNhan: string;
            const Site: string;
            const DeliveryDate: string;
            const ReleaseStrategy: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
    namespace CssVcmDanhSachPoService {
        const baseUrl = "BookingVcmReport/CssVcmDanhSachPo";
        function Create(request: Serenity.SaveRequest<CssVcmDanhSachPoRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CssVcmDanhSachPoRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CssVcmDanhSachPoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CssVcmDanhSachPoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function ExcelImport(request: ExcelImportRequest, onSuccess?: (response: ExcelImportResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function ExcelUpdate(request: Serenity.ExcelUpdateRequest, onSuccess?: (response: ExcelImportResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function ExcelUpdateThongTinKhoXacNhan(request: Serenity.ExcelUpdateRequest, onSuccess?: (response: ExcelImportResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function UpdateStatus(request: Serenity.ListKeysRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function GetNumberOfPo(request: System.String, onSuccess?: (response: System.Decimal) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function GetNumberOfPoDeliveryOnThisDay(request: Serenity.POUpdateDeliveryDateRequest, onSuccess?: (response: System.Decimal) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function UpdateDeliveryDate(request: Serenity.POUpdateDeliveryDateRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function ValidateXacNhanKhoXacNhanLichGiao(request: Serenity.ListKeysRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function ConfirmWarehouseStatus(request: Serenity.ListKeysRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function DenyWarehouseStatus(request: Serenity.POUpdateDeliveryDateRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function DeletePO(request: Serenity.ListKeysRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function KhoHuyLichDonHang(request: Serenity.POUpdateDeliveryDateRequest, onSuccess?: (response: Serenity.BaseUpdateResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function getListStringColumnsThuTuXapXep(request: Serenity.ServiceRequest, onSuccess?: (response: System.Collections.Generic.List<string>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function getThongTinDonHangTheoMaPO(request: System.Collections.Generic.List<string>, onSuccess?: (response: System.Collections.Generic.IEnumerable<CssVcmDanhSachPoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function getDicEmailTheoMaNCC(request: System.Collections.Generic.List<string>, onSuccess?: (response: System.Collections.Generic.Dictionary<string, string>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
            ...
            const List: string;
            const ExcelImport: string;
            const ExcelUpdate: string;
            const ExcelUpdateThongTinKhoXacNhan: string;
            const UpdateStatus: string;
            const GetNumberOfPo: string;
            const GetNumberOfPoDeliveryOnThisDay: string;
            const UpdateDeliveryDate: string;
            const ValidateXacNhanKhoXacNhanLichGiao: string;
            const ConfirmWarehouseStatus: string;
            const DenyWarehouseStatus: string;
            const DeletePO: string;
            const KhoHuyLichDonHang: string;
            const getListStringColumnsThuTuXapXep: string;
            const getThongTinDonHangTheoMaPO: string;
            const getDicEmailTheoMaNCC: string;
        }
    }
}
declare namespace eLink.BookingVcmReport {
...
declare namespace eLink.BookingVcmReport {
    class KhoHuyLichDonHangForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface KhoHuyLichDonHangForm {
        Note: Serenity.StringEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    class PODenyWarehouseStatusForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface PODenyWarehouseStatusForm {
        Note: Serenity.StringEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    class POExcelImportForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface POExcelImportForm {
        FileName: Serenity.ImageUploadEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    class POExcelUpdateForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface POExcelUpdateForm {
        FileName: Serenity.ImageUploadEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    class POExcelUpdateThongTinKhoXacNhanForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface POExcelUpdateThongTinKhoXacNhanForm {
        FileName: Serenity.ImageUploadEditor;
    }
}
declare namespace eLink.BookingVcmReport {
    class POUpdateDeliveryDateForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface POUpdateDeliveryDateForm {
        DeliveryDate: Serenity.DateTimeEditor;
        PODeliveryOnDay: Serenity.StringEditor;
        Note: Serenity.StringEditor;
    }
}
declare namespace eLink.Common.Pages {
...
declare namespace Serenity {
    interface CssVcmDanhSachPoRequest extends Serenity.ServiceRequest {
    }
}
declare namespace Serenity {
    interface CssVcmDanhSachPoResponse extends Serenity.ServiceResponse {
        Values?: {
            [key: string]: any;
        }[];
    }
...
declare namespace Serenity {
    interface ExcelUpdateRequest extends Serenity.ServiceRequest {
        FileName?: string;
    }
}
declare namespace Serenity {
    interface GetContactByGroupRequest extends Serenity.ServiceRequest {
        GroupCode?: string;
    }
}
declare namespace Serenity {
    interface GetDateTimeServerByTypeRequest extends Serenity.ServiceRequest {
        Type?: string;
    }
}
declare namespace Serenity {
    interface GetDateTimeServerByTypeResponse extends Serenity.ServiceResponse {
        FromTime?: string;
        ToTime?: string;
    }
}
declare namespace Serenity {
    interface GetDateTimeServerRequest extends Serenity.ServiceRequest {
    }
}
declare namespace Serenity {
    interface GetDateTimeServerResponse extends Serenity.ServiceResponse {
        DateTimeNow?: string;
...
declare namespace Serenity {
    interface ListCustomRequest extends Serenity.ListRequest {
        Type?: string;
    }
}
declare namespace Serenity {
    interface ListKeysExRequest extends Serenity.ListRequest {
        Keys?: string[];
    }
}
declare namespace Serenity {
    interface ListKeysRequest extends Serenity.ServiceRequest {
        Keys?: string[];
    }
}
declare namespace Serenity {
    interface ListSelectedRequest extends Serenity.ListRequest {
        ListKeySelected?: string[];
    }
}
declare namespace eLink.Membership {
...
declare namespace Serenity {
    interface POUpdateDeliveryDateRequest extends Serenity.ServiceRequest {
        DeliveryDate?: string;
        Keys?: string[];
        Note?: string;
    }
...
declare namespace Serenity {
    interface POUpdateDeliveryDateResponse extends Serenity.ServiceResponse {
        Updated?: number;
        ErrorList?: string[];
    }
}
declare namespace eLink.QuanLyHocSinh {
}
declare namespace eLink.QuanLyHocSinh {
    class QuanLyHocSinhForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface QuanLyHocSinhForm {
...
declare namespace eLink.QuanLyHocSinh {
    ...
    namespace QuanLyHocSinhRow {
        const idProperty = "Id";
        const nameProperty = "MaHs";
        const localTextPrefix = "QuanLyHocSinh.QuanLyHocSinh";
        namespace Fields {
            const Id: string;
            const MaHs: string;
            const TenHs: string;
...
declare namespace eLink.QuanLyHocSinh {
    namespace QuanLyHocSinhService {
        const baseUrl = "QuanLyHocSinh/QuanLyHocSinh";
        function Create(request: Serenity.SaveRequest<QuanLyHocSinhRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<QuanLyHocSinhRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<QuanLyHocSinhRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<QuanLyHocSinhRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace eLink.ScriptInitialization {
}
declare namespace eLink.Common {
...
declare namespace eLink.QuanLyHocSinh {
    class QuanLyHocSinhDialog extends Serenity.EntityDialog<QuanLyHocSinhRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: QuanLyHocSinhForm;
        protected getDialogTitle(): string;
        getToolbarButtons(): any[];
    }
}
declare namespace eLink.QuanLyHocSinh {
    class QuanLyHocSinhGrid extends Serenity.EntityGrid<QuanLyHocSinhRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof QuanLyHocSinhDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        protected rowSelection: Serenity.GridRowSelectionMixin;
